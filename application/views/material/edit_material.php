<div class="card card-primary">
    ...
    <?php } } ?> -->
    <?php echo form_open('edit-material/'.$material->material_id) ?>
    ...
    <div class="form-group col-md-4">
            ...
            <select name="developer_id" id="developer_select" class="form-select" required>
                ...
                <option value="<?php echo($developer->developer_id) ?>" <?php echo ($developer->developer_id == $material->developer_id ? 'selected' : '') ?>>
        ...
        <div class="form-group col-md-4">
            ...
            <select name="project_id" id="project_select" class="form-select project_select" required>
                <option value="<?php echo $material->project_id ?>" selected class="text-danger"><?php echo get_projectname_by_id($material->project_id) ?></option>

            </select>
        </div>
        <div class="form-group col-md-4">
            <label for="exampleInputPassword1">Material Name:</label>
            <input type="text" name="material_name" class="form-control" id="exampleInputPassword1" placeholder="Material name" value="<?php echo $material->material_name?>" required>
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" name="material_qty" class="form-control" id="unit_qty" placeholder="Material Qty" value="<?php echo $material->material_quantity?>" required>
        </div>
        <div class="form-group col-md-4">
            <label for="exampleInputPassword1">Material Unit Price:</label>
            <input type="text" name="unit_price" class="form-control" id="unit_price" placeholder="Unit Price" value="<?php echo $material->material_price ?>" required>
        </div>
        <div class="form-group col-md-4">
            <label for="exampleInputPassword1">Total Amount:</label>
            <input type="text" name="total_amount" class="form-control" id="total_amount" placeholder="Total Amount" value="<?php echo $material->total_amount ?>" required>
        </div>
        <div class="form-group col-md-4">
