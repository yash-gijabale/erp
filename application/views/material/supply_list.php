            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo get_developer_by_id($material->developer_id) ?></td>
                        <td><?php echo get_projectname_by_id($material->project_id) ?></td>
                        <td><?php echo get_material_name($material->material_id) ?></td>
                        <td><?php echo $material->material_qauntity ?></td>
                        <td><?php echo 'Rs. '.$material->total_amount ?></td>
                        <td><?php echo date('d-M-Y',strtotime($material->supply_at)) ?></td>
